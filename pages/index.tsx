    ...
    <>
      ...
      <Container maxW={"3xl"}>
        ...
        >
          ...
          <Text color={"gray.500"}>
            This is the home page of your SaaS. You are now signed in, and you
            can start doing... whatever you are here to do 🙌
            <br />
            <br />
            Remember to like the <Link href="">GitHub repo</Link> and give Simon
            a like on YouTube.
          </Text>
          <Stack
            direction={"column"}
